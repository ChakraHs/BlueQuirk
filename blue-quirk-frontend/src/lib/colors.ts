...
const COLOR_HEX: Record<string, string> = {
  ...
  "dark grey": "#4b5563", "dark gray": "#4b5563", "gris foncé": "#4b5563",
  "light grey": "#d1d5db", "light gray": "#d1d5db", "gris clair": "#d1d5db",
...
const NAMED_COLORS: NamedColor[] = [
  ...
  { hex: "#4b5563", fr: "Gris foncé", en: "Dark grey", ar: "رمادي داكن" },
  { hex: "#d1d5db", fr: "Gris clair", en: "Light grey", ar: "رمادي فاتح" },
