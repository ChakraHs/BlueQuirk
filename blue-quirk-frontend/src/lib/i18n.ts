...
const fr: Dict = {
  ...
  "hero.title": "Des créations que vous ne verrez sur personne d'autre.",
  "hero.subtitle":
  ...
  "hero.reassure1": "Livraison gratuite",
  ...
  "product.trustEta": "Livrée en 24–48h",
  "product.trustReturns": "Retours sous 14 jours",
  "whatsapp.aria": "Nous contacter sur WhatsApp",
  "whatsapp.prefill": "Bonjour RedQuirk, j'ai une question sur",
  // search
  ...
  "cart.remove": "Retirer",
  "cart.free": "Gratuite",
  "cart.shippingAtCheckout": "Calculée à l'étape suivante",
  "checkout.shippingAfterCity": "Calculée après le choix de la ville",
  // wishlist
  ...
  "checkout.fullNameRequired": "Nom complet requis",
  "checkout.email": "E-mail",
  "checkout.emailHint": "Requis si vous souhaitez suivre l'état de votre commande par e-mail.",
  "checkout.phone": "Téléphone",
  "checkout.address": "Adresse",
  "checkout.city": "Ville",
  "checkout.postalCode": "Code postal",
  "checkout.note": "Note",
  "checkout.notePlaceholder": "Ex. : confirmer par WhatsApp, appeler avant la livraison, livraison au bureau…",
  ...
  "checkout.bumpTitle": "Ajoutez à votre commande",
  "checkout.bumpAdd": "Ajouter",
  "checkout.viewDetails": "Voir les détails",
  ...
  "checkout.etaFallback": "Sous 1 à 3 jours ouvrables",
  ...
  "trust2.reviews": "Avis clients vérifiés",
  ...
  "reviews.emptyTitle": "Soyez le premier à donner votre avis",
  "reviews.emptyBody": "Partagez votre expérience une fois votre commande reçue.",
  // Review submission page
  "review.submit.title": "Donnez votre avis",
  "review.submit.subtitle": "Votre retour aide d'autres clients à choisir en confiance.",
...
const en: Dict = {
  ...
  "hero.reassure1": "Free delivery",
  "hero.reassure2": "Cash on delivery",
  "hero.reassure3": "14-day returns",
  "hero.subtitle":
    "Premium cotton tees, printed in Morocco. Cash on delivery, free shipping anywhere in Morocco.",
  ...
  "product.trustEta": "Delivered in 24–48h",
  "product.trustReturns": "14-day returns",
  "whatsapp.aria": "Chat with us on WhatsApp",
  "whatsapp.prefill": "Hi RedQuirk, I have a question about",
  ...
  "cart.remove": "Remove",
  "cart.free": "Free",
  "cart.shippingAtCheckout": "Calculated at the next step",
  "checkout.shippingAfterCity": "Calculated after choosing your city",
  ...
  "checkout.fullNameRequired": "Full name required",
  "checkout.email": "Email",
  "checkout.emailHint": "Required if you'd like to track your order status by email.",
  "checkout.phone": "Phone",
  "checkout.address": "Address",
  "checkout.city": "City",
  "checkout.postalCode": "Postal code",
  "checkout.note": "Note",
  "checkout.notePlaceholder": "e.g. confirm on WhatsApp, call before delivery, deliver to office…",
  ...
  "checkout.bumpTitle": "Add to your order",
  "checkout.bumpAdd": "Add",
  "checkout.viewDetails": "See details",
  ...
  "checkout.etaFallback": "Within 1 to 3 business days",
...
const ar: Dict = {
  ...
  "hero.title": "تصاميم لن تراها على أحد غيرك.",
  "hero.subtitle":
  ...
  "product.trustEta": "التوصيل خلال 24–48 ساعة",
  "product.trustReturns": "إرجاع خلال 14 يومًا",
  "whatsapp.aria": "تواصل معنا على واتساب",
  "whatsapp.prefill": "مرحبًا RedQuirk، لديّ سؤال حول",
  ...
  "cart.remove": "إزالة",
  "cart.free": "مجاني",
  "cart.shippingAtCheckout": "تُحتسب في الخطوة التالية",
  "checkout.shippingAfterCity": "تُحتسب بعد اختيار المدينة",
  ...
  "checkout.emailHint": "مطلوب إذا كنت ترغب في تتبّع حالة طلبك عبر البريد الإلكتروني.",
  "checkout.phone": "الهاتف",
  "checkout.address": "العنوان",
  "checkout.city": "المدينة",
  "checkout.postalCode": "الرمز البريدي",
  "checkout.note": "ملاحظة",
  "checkout.notePlaceholder": "مثال: التأكيد عبر واتساب، الاتصال قبل التوصيل، التوصيل إلى المكتب…",
  ...
  "checkout.bumpTitle": "أضِف إلى طلبك",
  "checkout.bumpAdd": "أضف",
  "checkout.viewDetails": "عرض التفاصيل",
  ...
  "checkout.etaFallback": "خلال 1 إلى 3 أيام عمل",
  ...
  "trust2.reviews": "تقييمات موثّقة من العملاء",
  // Reviews / social proof
  ...
  "reviews.close": "إغلاق",
  "reviews.emptyTitle": "كون أول من يشارك تجربتو معانا",
  "reviews.emptyBody": "عطينا رأيك من بعد ما يوصلك الطلب ديالك.",
  // Review submission page
  "review.submit.title": "شارك رأيك معانا",
  "review.submit.subtitle": "رأيك كيعاون عملاء آخرين باش يشريو بثقة.",
  "review.submit.chooseProduct": "شنو المنتوج اللي بغيتي تقيّم؟",
  "review.submit.chooseProducts": "شنو المنتوجات اللي بغيتي تقيّم؟",
  ...
  "review.submit.bodyPlaceholder": "كيفاش لقيتي الجودة، المقاس والقماش…؟",
  "review.submit.nameLabel": "اسمك الأول",
  "review.submit.sizeLabel": "المقاس المطلوب",
  "review.submit.colorLabel": "اللون",
  "review.submit.photoLabel": "زيد صورة",
  "review.submit.photoHint": "بيّن كيفاش كيبان المنتوج عليك — اختياري.",
  "review.submit.submit": "إرسال تقييمي",
  "review.submit.submitting": "جارٍ الإرسال…",
  "review.submit.successTitle": "شكراً بزاف على رأيك!",
  "review.submit.successBody": "غادي يتنشر من بعد ما يتأكد منو الفريق ديالنا.",
