...
const fr: Dict = {
  ...
  "checkout.emailHint": "Requis uniquement si vous souhaitez suivre l'état de votre commande et recevoir les mises à jour par e-mail.",
...
const en: Dict = {
  ...
  "checkout.emailHint": "Only required if you'd like to track your order status and receive updates by email.",
...
const ar: Dict = {
  ...
  "checkout.emailHint": "مطلوب فقط إذا كنت ترغب في تتبّع حالة طلبك وتلقّي التحديثات عبر البريد الإلكتروني.",
